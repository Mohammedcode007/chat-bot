...
class BotRuntime {
  constructor() {
    ...
    /*
      يمنع تسجيل دخول كل البوتات في نفس اللحظة.
      عدّل القيمة من .env:
      BOT_START_DELAY_MS=3000
    */
    this.botStartDelayMs = Number(process.env.BOT_START_DELAY_MS || 3000);
  ...
  start() {
    ...
    /*
      Admin أولًا، ثم باقي البوتات بالتدريج.
    */
    this.startAdminBot();
  ...
  startAdminBot() {
    ...
    /*
      admin bot يبدأ مباشرة.
      لو تريد حتى admin يدخل بالتدريج، قل لي وأجعله داخل queue.
    */
    this.adminBot.start();
  }
